...
Use the [Pathview R package](https://academic.oup.com/bioinformatics/article-lookup/doi/10.1093/bioinformatics/btt285) to integrate the KEGG pathway data from clusterProfiler into pathway images:
